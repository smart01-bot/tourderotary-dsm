...
import { LayoutDashboard, CalendarDays, ScanLine, LogOut, Menu, X } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/volunteer/shifts',    label: 'Shifts',    icon: CalendarDays    },
  { href: '/volunteer/checkin',   label: 'Check-in',  icon: ScanLine        },
]
    ...
    <aside className="flex flex-col h-full w-60 bg-navy px-4 py-6">
      ...
      <div className="flex items-center gap-2.5 px-2 mb-8">
        ...
        <div className="min-w-0">
          ...
          <p className="text-white/40 text-[10px] font-semibold uppercase tracking-wider">Volunteer</p>
        </div>
        <button
