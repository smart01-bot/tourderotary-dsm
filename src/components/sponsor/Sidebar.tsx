...
import { LayoutDashboard, Download, BarChart2, LogOut, Menu, X } from 'lucide-react'
...
const NAV = [
  ...
  { href: '/sponsor/assets',    label: 'Assets',    icon: Download         },
  { href: '/sponsor/reporting', label: 'Reporting', icon: BarChart2        },
]
    ...
    <aside className="flex flex-col h-full w-60 bg-navy px-4 py-6">
      ...
      <div className="flex items-center gap-2.5 px-2 mb-8">
        ...
        <div className="min-w-0">
          ...
          <p className="text-white/40 text-[10px] font-semibold uppercase tracking-wider">Sponsor</p>
        </div>
        <button
